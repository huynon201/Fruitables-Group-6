                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="blog__item">
                                        <div class="blog__item__pic">
                                            <img style="width: 370px; height: 266px;" src="${pageContext.request.contextPath}/blog/image/${itemBox.blogImg}"/>" alt="">
                                        </div>
                                        <div class="blog__item__text">
                                            ...
                                            <p>${itemBox.content}</p>
                                            <a href="${pageContext.request.contextPath}/blog-detail/${itemBox.id}" class="blog__btn">READ MORE <span class="arrow_right"></span></a>
                                        </div>
                                    </div>
                                </div>
